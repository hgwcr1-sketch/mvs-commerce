...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('purchase_item_taxes', function (Blueprint $table) {
            ...
            $table->index(['purchase_item_id', 'sequence']);
        });

        Schema::create('sale_return_item_taxes', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['sale_return_item_id', 'sequence']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('sale_return_item_taxes');
