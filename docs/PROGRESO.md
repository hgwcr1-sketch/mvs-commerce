...
- **Evidencia P01–P09A:** `LoyaltyPortalSelfRegistrationTest` **11/11, 52 aserciones** + `LoyaltyPortalClientAccessTest` **11/11, 55 aserciones** + `LoyaltyPortalDeliveryTest` **7/7, 51 aserciones** + `LoyaltyPortalCentralTest` **4/4, 17 aserciones** + `CustomerPublicCodeTest` **5/5, 23 aserciones, 0 fallos**. `LoyaltyCustomerPortal` 13/13, 89 aserciones.
- **P09B y siguientes: PENDIENTES.** Siguiente **P09B** – QR individual + Code 128 generados por MVS; no P09C lectura POS, no P09D PIN/QR temporal.
