...
### Portal de Clientes — P01–P17: COMPLETADO (P18 siguiente)
...
- **P18 — SIGUIENTE** — una vez por cliente más teléfono/correo verificado. P31 queda después de P18–P20.
...
- **P14–P17 — COMPLETADOS.** Siguiente **P18** – una vez por cliente más teléfono/correo verificado.
