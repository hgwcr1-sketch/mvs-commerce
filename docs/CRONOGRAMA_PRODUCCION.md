...
- **P31–P35: COMPLETADOS ADELANTADAMENTE por autorización expresa** – infraestructura común identificada/reutilizada; Clientes, Productos y Ventas históricas quedan migrables con preview, validación, idempotencia, exportación y rollback. P34/P35 escriben solo `sales`/`sale_items` marcados como históricos, sin servicios operativos. Esto no cambia el orden pendiente: P25 sigue siendo el siguiente bloque oficial; P36 no se implementó.
- **P09A–P09D: COMPLETADOS** – conservan esos IDs exactos.
- **Migración:** P31–P35 quedaron completados adelantadamente por autorización expresa; P36–P40 conservan sus IDs y su posición posterior a P25–P30.
