...
## Estado actual de Portal de Clientes (P01–P05) — reconciliado con Excel único

Fuente oficial: `docs/CRONOGRAMA_PRODUCCION.md` (P01–P50) y referencia visual `docs/Cronograma_Unico_Portal_Correcciones_MVS_Commerce_28-08-2026.xlsx`. Reemplaza cronogramas anteriores; **P01–P05 COMPLETADOS**, P06 es el siguiente bloque, P09A–P09D conservan esos IDs exactos, migración P31–P40 después de los bloques existentes sin reutilizar IDs.
...
- **P06 y siguientes: PENDIENTES.** Siguiente **P06** – Crear acceso al Portal al registrar/crear cliente rápido; no QR individual/Code128 (P09B), no lectura POS (P09C), no PIN/QR temporal (P09D).
...
- Evidencia P01–P05: `LoyaltyPortalSelfRegistrationTest` **11 tests, 52 aserciones, 0 fallos** (incl. `test_register_blocks_when_identification_and_phone_match_different_customers`, `test_register_blocks_when_email_matches_different_customer_than_phone` y `test_register_creates_loyalty_account_automatically` con `loyalty_accounts`).
