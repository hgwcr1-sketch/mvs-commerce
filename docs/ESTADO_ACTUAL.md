...
## Estado actual de Portal de Clientes (P01–P08) — reconciliado con Excel único

Fuente oficial: `docs/CRONOGRAMA_PRODUCCION.md` (P01–P50) y referencia visual `docs/Cronograma_Unico_Portal_Correcciones_MVS_Commerce_28-08-2026.xlsx`. Reemplaza cronogramas anteriores; **P01–P08 COMPLETADOS**, P09 es el siguiente bloque, P09A–P09D conservan esos IDs exactos, migración P31–P40 después de los bloques existentes sin reutilizar IDs.
...
- Evidencia P01–P08: `LoyaltyPortalSelfRegistrationTest` **11/11, 52 aserciones** + `LoyaltyPortalClientAccessTest` **11/11, 55 aserciones** + `LoyaltyPortalDeliveryTest` **7/7, 51 aserciones, 0 fallos** (incl. `test_clientes_store_returns_delivery_with_url_username_and_temporary_password`, `test_temporary_password_only_in_initial_response`, `test_whatsapp_uses_normalized_phone`, aislamiento y no persistencia plain). `LoyaltyCustomerPortal` 13/13.
