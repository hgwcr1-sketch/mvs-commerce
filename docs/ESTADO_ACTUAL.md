...
## Estado actual de Portal de Clientes (P01–P17) — reconciliado con Excel único

**P10–P17 COMPLETADOS.** P11–P13 consolidan el patrón UI responsive. P14–P16 crean el incentivo único, sus tipos y reglas de compra/vencimiento. P17 agrega sucursales participantes, oferta permitida/bloqueada, descuento máximo decimal y stacking/combinabilidad como snapshots por claim, con validación previa al consumo. Regresión P14–P17/Portal/POS/canjes: 162 tests, 972 aserciones. **P18 es el siguiente bloque.**

Fuente oficial: `docs/CRONOGRAMA_PRODUCCION.md` (P01–P50) y referencia visual `docs/Cronograma_Unico_Portal_Correcciones_MVS_Commerce_28-08-2026.xlsx`. Reemplaza cronogramas anteriores; **P01–P17 COMPLETADOS** (incluidos P09A–P09D con sus IDs exactos), P18 es el siguiente bloque y la migración P31–P40 permanece después de P18–P20 sin reutilizar IDs. **P09 ajuste visual QR compacto: commit `58aba11`**.
...
- Puesta en Producción: **P01–P17 COMPLETADOS** (incluidos P09A–P09D); **P09 ajuste QR compacto commit `58aba11`**. P17 extiende sin reconstruir P14–P16: sucursales participantes, oferta, tope de descuento y combinabilidad quedan aislados por empresa, congelados en el claim y validados antes del consumo. **P18 SIGUIENTE BLOQUE** – una vez por cliente más teléfono/correo verificado. **Regla producción: desarrollo → validación local del usuario → APROBADO PARA PRODUCCIÓN → despliegue controlado; los agentes no despliegan producción automáticamente.**
...
**Prioridad inmediata: P18 — una vez por cliente más teléfono/correo verificado; P31 no inicia hasta cerrar P18–P20 en orden.**
