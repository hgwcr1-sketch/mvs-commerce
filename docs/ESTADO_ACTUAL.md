...
- **P37.1 — Portal Comercial Premium de Fidelización: FASE 1 ES EL TRABAJO ACTUAL antes de retomar P33/migración definitiva.** Alcance inmediato: corregir imágenes de publicaciones; mejorar formulario responsive/touch; múltiples imágenes con carrusel/swipe; CTA configurable; enlaces sociales opcionales; puntos próximos a vencer; personalización tenant; y Passkeys/WebAuthn sin almacenar biometría. La Fase 2 queda después de la migración definitiva para PWA, push con consentimiento, segmentación, recuperación, campañas/incentivos/promociones personalizados, automatizaciones, anti-spam y métricas. No integrar automáticamente APIs Meta/TikTok todavía. Al cerrar Fase 1, volver al orden operativo **Productos → Inventario San Ramón → Inventario Liberia**.
- **Principios P37.1:** Fidelización es una herramienta sutil de retención y ventas; MVS detecta/recomienda y los incentivos económicos respetan únicamente reglas autorizadas por cada empresa. Aislamiento SaaS y mobile-first son obligatorios.
