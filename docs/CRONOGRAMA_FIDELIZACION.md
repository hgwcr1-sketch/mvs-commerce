...
| 10. Portal cliente | Web + QR + promociones | EN CURSO — F30–F32 COMPLETADOS; pendientes F33–F35 |
...
- **Completadas:** F01–F32 según maestro (F28 completada de forma adelantada durante la integración POS, `7be1f80`).
...
- **SIGUIENTE:** **F33 — QR seguro** (etapa 10). Única fase autorizada para iniciar tras F32.
