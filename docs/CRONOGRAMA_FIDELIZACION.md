...
- **Completadas:** F01–F35 según maestro (F28 completada de forma adelantada durante la integración POS, `7be1f80`). Etapa 10 (Portal cliente) completa.
...
- **SIGUIENTE:** **F36 — Acumulación online** (etapa 11. Tienda online).
