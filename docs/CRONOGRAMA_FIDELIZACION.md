...
| 10. Portal cliente | Web + QR + promociones | EN CURSO — F30–F34 COMPLETADOS; pendiente F35 |
...
- **Completadas:** F01–F34 según maestro (F28 completada de forma adelantada durante la integración POS, `7be1f80`).
...
- **SIGUIENTE:** **F35 — Publicidad/promociones** (etapa 10).
