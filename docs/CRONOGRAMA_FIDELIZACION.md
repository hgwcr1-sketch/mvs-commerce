...
- **Completadas:** F01–F23 según maestro; F28 completada de forma adelantada durante la integración POS (`7be1f80`).
...
- **SIGUIENTE:** **F24 — Centro de reglas** (etapa 7). Única fase autorizada para iniciar tras F23.
