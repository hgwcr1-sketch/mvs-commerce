...
| 10. Portal cliente | Web + QR + promociones | PARCIAL — F30 COMPLETADO; pendientes F31–F35 |
...
- **Completadas:** F01–F30 según maestro (F28 completada de forma adelantada durante la integración POS, `7be1f80`).
...
- **SIGUIENTE:** **F31 — Identidad visual del portal** (etapa 10). Única fase autorizada para iniciar tras F30.
