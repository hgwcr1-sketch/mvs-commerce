    ...
    private function definition(string $type, int $companyId): array
    {
        ...
        $definitions = [
            ...
            'products' => ['title' => 'Productos', 'headers' => ProductImportService::HEADERS, 'fields' => $this->fields(ProductImportService::HEADERS, [
                ...
                'proveedor' => ['text', 'Texto; proveedor activo de la empresa (nombre o nombre comercial)', 'Seleccione un proveedor existente o deje vacío; no se crean proveedores', 'Proveedor ejemplo'],
                'codigo_producto_proveedor' => ['text', 'Texto; opcional; solo con proveedor', 'Código del producto en el proveedor o vacío', 'SKU-PROV-1'],
                ...
                'proveedor' => \App\Models\Supplier::query()->where('company_id', $companyId)->where('is_active', true)->whereNull('deleted_at')->orderBy('name')->pluck('name')->all(),
