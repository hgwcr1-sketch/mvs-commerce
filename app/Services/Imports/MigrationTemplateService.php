    ...
    private function definition(string $type, int $companyId): array
    {
        ...
        $definitions = [
            ...
            'products' => ['title' => 'Productos', 'headers' => ProductImportService::HEADERS, 'fields' => $this->fields(ProductImportService::HEADERS, [
                ...
                'costo' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1000.0000', '#,##0.0000'], 'precio_venta' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1500.0000', '#,##0.0000'],
                'precio_mayorista' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1400.0000', '#,##0.0000'], 'precio_especial' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1450.0000', '#,##0.0000'],
                'precio_a' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1480.0000', '#,##0.0000'], 'precio_b' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1470.0000', '#,##0.0000'], 'precio_c' => ['number', 'Monto no negativo, máximo 4 decimales', null, '1460.0000', '#,##0.0000'],
