    ...
    private function definition(string $type, int $companyId): array
    {
        ...
        $definitions = [
            ...
            'products' => ['title' => 'Productos', 'headers' => ProductImportService::HEADERS, 'fields' => $this->fields(ProductImportService::HEADERS, [
                ...
                'costo' => ['number', 'Monto no negativo, máximo 2 decimales; acepta hasta 4 si los adicionales son ceros', null, '1000.0000', '#,##0.0000'], 'precio_venta' => ['number', 'Monto no negativo, máximo 2 decimales; acepta hasta 4 si los adicionales son ceros', null, '1500.0000', '#,##0.0000'],
