...
{
    public const TYPE_OPENED = 'opened'; public const TYPE_ENTRY = 'entry'; public const TYPE_EXIT = 'exit'; public const TYPE_WITHDRAWAL = 'withdrawal'; public const TYPE_CLOSING_STARTED = 'closing_started'; public const TYPE_DIFFERENCE_AUTHORIZED = 'difference_authorized'; public const TYPE_CLOSED = 'closed'; public const TYPE_EXCHANGE_RATE_CHANGED = 'exchange_rate_changed'; public const TYPE_REVERSAL = 'reversal';
