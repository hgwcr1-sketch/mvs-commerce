...
class CashSession extends Model
{
    ...
    protected $fillable = ['company_id', 'branch_id', 'cash_register_id', 'session_number', 'opened_by', 'closed_by', 'difference_authorized_by', 'status', 'open_guard', 'currency_code', 'opening_amount', 'expected_cash', 'counted_cash', 'difference_amount', 'tolerance_snapshot', 'accepts_usd_snapshot', 'usd_exchange_rate', 'exchange_rate_entered_by', 'opening_amount_usd', 'expected_cash_usd', 'counted_cash_usd', 'difference_amount_usd', 'blind_closing_snapshot', 'usd_change_policy_snapshot', 'opened_at', 'closed_at', 'difference_authorized_at', 'closing_notes'];

    protected function casts(): array
    {
        return ['opening_amount' => 'decimal:4', 'expected_cash' => 'decimal:4', 'counted_cash' => 'decimal:4', 'difference_amount' => 'decimal:4', 'tolerance_snapshot' => 'decimal:4', 'accepts_usd_snapshot' => 'boolean', 'usd_exchange_rate' => 'decimal:4', 'opening_amount_usd' => 'decimal:4', 'expected_cash_usd' => 'decimal:4', 'counted_cash_usd' => 'decimal:4', 'difference_amount_usd' => 'decimal:4', 'blind_closing_snapshot' => 'boolean', 'opened_at' => 'datetime', 'closed_at' => 'datetime', 'difference_authorized_at' => 'datetime'];
    }
