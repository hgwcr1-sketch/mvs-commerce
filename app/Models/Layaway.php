...
class Layaway extends Model {
 ...
 protected $fillable=['company_id','branch_id','customer_id','created_by','delivered_sale_id','number','client_token','request_fingerprint','status','currency_code','total','paid_total','balance_due','expires_at','paid_at','delivered_at','cancelled_at','expired_at','cancelled_by','cancel_reason','notes'];
