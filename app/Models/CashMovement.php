...
class CashMovement extends Model
{
    ...
    protected $fillable = ['company_id', 'branch_id', 'cash_register_id', 'cash_session_id', 'type', 'direction', 'amount', 'concept', 'reason', 'source_type', 'source_id', 'reversed_movement_id', 'created_by', 'authorized_by', 'occurred_at'];
