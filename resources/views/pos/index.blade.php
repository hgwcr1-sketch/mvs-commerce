...
<div x-data="posTerminal"
    ...
    <section class="rounded-xl bg-white p-2 shadow-sm">
        <div class="flex gap-1.5 overflow-x-auto">
            ...
            @can('notas_credito.crear')<a href="{{ route('devoluciones.index') }}" class="min-h-[44px] cursor-pointer whitespace-nowrap rounded-lg border border-primary bg-primary px-3 py-2 text-sm font-bold text-black hover:bg-primary-hover focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">Nota de Crédito</a>@endcan
            @can('notas_credito.aplicar')<button type="button" x-show="totalCreditNotesApplied > 0" class="min-h-[44px] whitespace-nowrap rounded-lg border border-emerald-300 bg-emerald-50 px-3 py-2 text-sm font-bold text-emerald-800">NC aplicadas: <span x-text="money(totalCreditNotesApplied)"></span></button>@endcan
