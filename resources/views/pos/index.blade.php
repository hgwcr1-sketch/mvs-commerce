    ...
    <section class="rounded-xl bg-white p-2 shadow-sm">
        <div class="flex gap-1.5 overflow-x-auto">
            ...
            <button
                ...
                :disabled="cart.length === 0 || suspended.saving"
                x-text="suspended.activeId && suspended.recoveryToken ? 'Volver a suspender' : 'Suspender'"
                class="pos-top-btn min-h-[44px] whitespace-nowrap rounded-lg border px-3 py-2 text-sm font-medium transition-colors hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500 disabled:cursor-not-allowed disabled:opacity-50"
                :class="cart.length === 0 || suspended.saving ? 'bg-slate-50 border-slate-200 text-slate-400 cursor-not-allowed' : 'bg-white border-slate-300 text-slate-700'">
            </button>

            <button
                type="button"
                @click="openSuspended"
                class="pos-top-btn min-h-[44px] whitespace-nowrap rounded-lg border px-3 py-2 text-sm font-medium transition-colors hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500"
                :class="'bg-white border-slate-300 text-slate-700'">
                Suspendidas
            </button>
            ...
            <button
                type="button"
                x-show="!quoteMode"
                @click="enterQuoteMode()"
                :disabled="!canCreateQuote || creatingQuote || checkout.open"
                class="pos-top-btn min-h-[44px] whitespace-nowrap rounded-lg border px-3 py-2 text-sm font-medium transition-colors hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500 disabled:cursor-not-allowed disabled:opacity-50"
                :class="!canCreateQuote || creatingQuote || checkout.open ? 'bg-slate-50 border-slate-200 text-slate-400 cursor-not-allowed' : 'bg-white border-slate-300 text-slate-700'">
                Cotizar
            </button>
            @endcan
            ...
            @can('notas_credito.aplicar')
                <button
                    type="button"
                    x-show="totalCreditNotesApplied > 0"
                    class="pos-top-btn min-h-[44px] whitespace-nowrap rounded-lg border px-3 py-2 text-xs font-medium transition-colors hover:bg-slate-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500"
                    :class="'bg-emerald-50 border-emerald-300 text-emerald-800'">
