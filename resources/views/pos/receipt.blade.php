...
<head>
    ...
    <style>
        *{box-sizing:border-box}html,body{height:auto}body{margin:0;background:#e2e8f0;color:#111827;font-family:Arial,Helvetica,sans-serif;line-height:1.35}
        ...
        .format-58mm{width:58mm;padding:3mm 3mm 4mm 3mm;font-size:11.5px}
        ...
        /* 58mm legible y compacto */
        .format-58mm h1{font-size:15px}
        .format-58mm h2{font-size:11.5px}
        .format-58mm .muted{font-size:10px}
        .format-58mm .details{font-size:11.5px;gap:3px}
        .format-58mm .warning{font-size:10.5px;padding:6px}
        .format-58mm .rule{margin:7px 0}
        .format-58mm .totals{max-width:100%;margin:0}
        .format-58mm .totals td{font-size:11.5px;padding:3px 0}
        .format-58mm .grand td{font-size:20px}
        /* items 58mm : 2 líneas */
        .items58{border-top:1px solid #e2e8f0}
        .item58{padding:6px 0;border-bottom:1px solid #e2e8f0;page-break-inside:avoid}
        .item58-name{font-size:12px;font-weight:700;line-height:1.3;word-break:break-word;color:#111827}
        .item58-name .muted{display:block;font-size:9.5px;font-weight:400;margin-top:1px}
        .item58-line{display:flex;justify-content:space-between;gap:6px;font-size:11px;margin-top:3px;align-items:flex-start}
        .item58-line .left{color:#334155;flex:1;word-break:break-word}
        .item58-line .right{font-weight:700;white-space:nowrap;color:#111827}
        .format-58mm .pay-table td,.format-58mm .loyalty-table td{font-size:11.5px;padding:3px 0}
        .format-58mm .thanks{margin-top:10px;font-size:12px}
        .format-58mm .thanks + .cut-tail{height:6mm}
        .format-80mm .thanks + .cut-tail{height:6mm}
    ...
    @if($format === '58mm')<style>@media print{@page{size:58mm auto;margin:0}}</style>@endif
    @if($format === '80mm')<style>@media print{@page{size:80mm auto;margin:0}}</style>@endif
</head>
<body>
